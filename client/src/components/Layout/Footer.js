  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        />
        <Text
          style={[styles.text, route.name === 'notification' && styles.active]}>
          Notification
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <AntDesign
          ...
          name="user"
        />
        <Text style={[styles.text, route.name === 'account' && styles.active]}>
          Account
        </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <AntDesign
          ...
          name="shoppingcart"
        />
        <Text style={[styles.text, route.name === 'cart' && styles.active]}>
          Cart
        </Text>
      </TouchableOpacity>
